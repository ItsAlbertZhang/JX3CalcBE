    ...
    for (auto &it : skill.attrAttributes) {
        ...
        case static_cast<int>(ref::lua::ATTRIBUTE_EFFECT_MODE::EFFECT_TO_SELF_NOT_ROLLBACK): {
            ...
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::CURRENT_SUN_ENERGY):
                ...
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::CURRENT_MOON_ENERGY):
            ...
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::DEL_MULTI_GROUP_BUFF_BY_ID):
                ...
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::SUN_POWER_VALUE):
                self->nSunPowerValue = it.param1Int;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::MOON_POWER_VALUE):
                self->nMoonPowerValue = it.param1Int;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::STOP):
                // 未做相关实现, 推测为停止, 用于解除击飞
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::DO_ACTION):
                // 未做相关实现, 推测为动作
                break;
            default:
        ...
        case static_cast<int>(ref::lua::ATTRIBUTE_EFFECT_MODE::EFFECT_TO_SELF_AND_ROLLBACK): {
            switch (it.type) {
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::SKILL_PHYSICS_DAMAGE):
                this->atDamage[static_cast<int>(DamageType::Physics)] += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::SKILL_PHYSICS_DAMAGE_RAND):
                this->atDamageRand[static_cast<int>(DamageType::Physics)] += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::SKILL_SOLAR_DAMAGE):
            ...
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::SKILL_POISON_DAMAGE):
                ...
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::SKILL_POISON_DAMAGE_RAND):
                this->atDamageRand[static_cast<int>(DamageType::Poison)] += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::PHYSICS_ATTACK_POWER_PERCENT):
            ...
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::DST_NPC_DAMAGE_COEFFICIENT):
                self->chAttr.atDstNpcDamageCoefficient += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::MAGIC_SHIELD):
                self->chAttr.atMagicShield += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::PHYSICS_SHIELD_BASE):
                self->chAttr.atPhysicsShieldBase += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::DROP_DEFENCE):
                // 未做相关实现, 推测为摔落保护
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::ACTIVE_THREAT_COEFFICIENT):
                // 未做相关实现, 推测为威胁值
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::BEAT_BACK_RATE):
                // 未做相关实现, 推测为运功被打退概率
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::SPUNK_TO_SOLAR_AND_LUNAR_ATTACK_POWER_COF):
                self->chAttr.atSpunkToSolarAndLunarAttackPowerCof += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::SPUNK_TO_SOLAR_AND_LUNAR_CRITICAL_STRIKE_COF):
                self->chAttr.atSpunkToSolarAndLunarCriticalStrikeCof += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::MAX_SUN_ENERGY):
                self->chAttr.atMaxSunEnergy += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::MAX_MOON_ENERGY):
                self->chAttr.atMaxMoonEnergy += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::MAX_LIFE_PERCENT_ADD):
                // 未做相关实现, 推测为额外最大生命值
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::SOLAR_ATTACK_POWER_BASE):
                self->chAttr.atSolarAttackPowerBase += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::LUNAR_ATTACK_POWER_BASE):
                self->chAttr.atLunarAttackPowerBase += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::MANA_REPLENISH_PERCENT):
                // 未做相关实现, 推测为内力回复
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::DECRITICAL_DAMAGE_POWER_BASE_KILONUM_RATE):
                self->chAttr.atDecriticalDamagePowerBaseKiloNumRate += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::PHYSICS_CRITICAL_STRIKE_BASE_RATE):
                self->chAttr.atPhysicsCriticalStrikeBaseRate += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::SOLAR_CRITICAL_STRIKE_BASE_RATE):
                self->chAttr.atSolarCriticalStrikeBaseRate += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::LUNAR_CRITICAL_STRIKE_BASE_RATE):
                self->chAttr.atLunarCriticalStrikeBaseRate += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::NEUTRAL_CRITICAL_STRIKE_BASE_RATE):
                self->chAttr.atNeutralCriticalStrikeBaseRate += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::POISON_CRITICAL_STRIKE_BASE_RATE):
                self->chAttr.atPoisonCriticalStrikeBaseRate += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::MAGIC_CRITICAL_DAMAGE_POWER_BASE_KILONUM_RATE):
            ...
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::SKILL_EVENT_HANDLER):
                ...
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::LUNAR_ATTACK_POWER_PERCENT):
                self->chAttr.atLunarAttackPowerPercent += it.param1Int * c;
                break;
            case static_cast<int>(ref::lua::ATTRIBUTE_TYPE::SOLAR_CRITICAL_DAMAGE_POWER_BASE_KILONUM_RATE):
